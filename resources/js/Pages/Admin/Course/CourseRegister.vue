        ...
        <div class="form" action="">
          <div class="form">
            <div class="form-group sml">
              <label
                >講座名
                <!-- <div class="char-count" v-if="countText(1) > 50">
                  <span>({{ countText(1) }}/50文字以内)</span>
                </div>
                <div class="char-count" v-if="countText(1) <= 50">
                  ({{ countText(1) }}/50文字以内)
                </div> -->
              ...
              <div class="w-100">
                <input
                  ...
                  class="form-control"
                  v-model="form.name"
                  @input="clearFeValidation(form.name, fe_erors.title)"
            ...
            <div class="form-group sml">
              ...
              <div class="w-100">
                <textarea
                  ...
                  id=""
                  class="form-control"
                  @input="clearFeValidation(form.summery)"
              ...
              <div class="flex-column">
                <div class="flex-row">
                  <select
                    ...
                    @change="
                      addCategories($event);
                      clearFeValidation(form.categories);
                    "
                    ref="catDropDown"
                  >
            ...
            <div class="form-group sml">
              ...
              <div class="flex-column">
                <input
                  ...
                  @keyup.enter="
                    addKeyword();
                    clearFeValidation(form.keywords);
                  "
                />
            ...
            <div class="form-group align-item-fs sml">
              ...
              <div class="flex-column">
                ...
                <div v-for="(row, index) in form.vedio_components" :key="index">
                  ...
                  <div class="row-bordered" v-if="row.type === 'title'">
                    <img
                      :src="'/images/icon-draggable.svg'"
                      class="icon-draggable"
                      alt=""
...
export default {
  ...
  methods: {
    ...
    addTitleToSubmit(id, index) {
      this.form.reports_for_submit.forEach((e) => {
        if (id == e.id) {
          e.title = this.form.reports[index].title;
          e.description = this.form.reports[index].description;
        } else {
          return;
        }
      });
    ...
    clearFeValidation(target, er_target) {
      // if(target.length <= 0){
      //   er_target = true;
      // }else{
      //   er_target = false;
