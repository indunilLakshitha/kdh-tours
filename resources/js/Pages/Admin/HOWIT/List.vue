        ...
        <table class="table notice-table">
          <thead>
            ...
            <tr>
              ...
              <th>Desctiption<span class="icon-sort"></span></th>
              <th>Status<span class="icon-sort"></span></th>
              <th>Action</th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="(notice, index) in HowItWorks" :key="index">
