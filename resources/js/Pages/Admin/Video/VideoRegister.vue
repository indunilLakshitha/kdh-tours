...
export default {
    ...
    methods: {
        submitVideoPublish() {
            ...
            this.form.post(route("video.store"), {
                onSuccess: () => {
        ...
        thumbUploadStatus(event) {
            ...
            if (acceptedMimes.includes(extension) && file[0].size < 5242880) {
                ...
                !acceptedMimes.includes(extension) &&
                file[0].size < 5242880
            ) {
                ...
                this.thumb_link = null;
                this.thumb_upload = true;
                this.errors.thumbnail = "5MB以内にしてください。";
                document.getElementById("submitVideo").disabled = true;
                document.getElementById("tempVideo").disabled = true;
            } else if (
                !acceptedMimes.includes(extension) &&
                ...
                this.thumb_upload = true;
                this.errors.thumbnail =
                    "ファイル形式をjpg,jpeg,png,gif,svgのみです。| 5MB以内にしてください。";
                document.getElementById("submitVideo").disabled = true;
                document.getElementById("tempVideo").disabled = true;
            } else {
            }
