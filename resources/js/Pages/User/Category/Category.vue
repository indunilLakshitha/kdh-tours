<template>
  <AppLayoutUser>
    <div class="user-layout">
      <div class="content full-width category">
        <div class="page-container">
          <SearchArea :categories="categories" :back_button="false" />
          ...
          <section>
            ...
            <!-- <div class="card-row">
              <div class="card video-card" v-for="item in 8">
                ...
                <div class="card-content">
                  ...
                  <div class="info-area">
                    <div class="left">
                      ...
                      <span><img :src="'/images/icon-tag.svg'" alt="" />カテゴリー</span>
                    </div>
                    <div class="right">
          ...
          <!-- section | ends -->
          <section v-for="(category, index) in courses" :key="index">
            <div v-if="category.courses.length > 0">
              <div class="title-area">
                <h3>{{ category.name }}</h3>
                <Link :href="getUrl(category.id)" class="view-more">もっと見る</Link>
              </div>
              <div class="card-row">
                <div
                ...
                >
                  ...
                  >
                    <div class="video-thumb-wrapper">
                      ...
                      ></div>
                      <!-- <div class="seek-bar" v-if="course.total_watchtime && course.course_activities" :style="'width:'+calPercent(course.total_watchtime,course.course_activities.total_watch_time)+'%'"></div> -->
                    </div>
                  </Link>
                  <Link
                    v-if="!course.first_video"
...
export default {
  ...
  methods: {
    getUrl(id) {
      return (this.url = "/category/search/" + id);
    },
    func(id) {
      var SchoolId = 0;
