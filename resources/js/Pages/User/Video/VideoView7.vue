<template>
  <AppLayoutUser>
    <div class="user-layout">
      <div class="content full-width video-view-7">
          ...
          <div class="page-container">
            ...
            <div class="video-info-area">
              ...
              <div class="info-area">
                <ul>
                  <li>
                    <img :src="'/images/icon-clock.svg'" alt="" />{{ this.courseDurationMinutes }} m
                    <img
                  ...
                  <li>
                    <img :src="'/images/icon-tag.svg'" alt="" />{{ this.courseCategory }}
                  </li>
                  <li v-if="this.courseReport">
                    <img :src="'/images/icon-pencil.svg'" alt="" />テスト・レポート　あり
                  </li>
                </ul>
                <div class="seekbar-area-wrapper">
                  ...
                  <div class="seekbar-area">
                    ...
                    <label for="">{{ this.totalPercentage }} <small>%</small></label>
                  </div>
                </div>
                <button v-if="edit_status"
                  type="button"
        ...
        <div class="gray-area">
          <div class="gray-content">
            ...
            <div v-for="(row, index) in this.postViewings" :key="index">
              <div class="download-row" v-if="row.type == 1">
                ...
                <img
                  ...
                  alt=""
                  @click.prevent="downloadItem(row.document)"
                />
              </div>
                  ...
                  <div v-for="(row2, index2) in row.belong_videos" :key="index2">
                    <li>
                      chapter0{{ index2 + 1 }}　{{ row2.belong_video.title
                        ...
                        >( {{ timeFunction(row2.belong_video.duration_seconds) }} )</span
                      >
                    </li>
                  </div>
                </ul>
...
export default {
  ...
  created() {
    ...
    this.courseCategory = this.courseDetails.course_has_categories[0]["category"].name;
  ...
  methods: {
    func(id) {
      ...
      Inertia.get(`/course/videoPlay/${this.firstVideoTitleDetails.id}/${this.firstVideoTitleDetails.vedio_id}/${this.courseDetails.id}`);
    },
    addToFav(course_id) {
